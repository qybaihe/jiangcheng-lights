...
const out=path.join(root,'output/demo-film-v4'),mode=process.argv[2]??'final';
...
const target=path.join(out,final?'江城有灯-比赛Demo-1080p-v4-render.mp4':'江城有灯-30秒风格样片-1080p-v4.mp4');
let last=-1;
