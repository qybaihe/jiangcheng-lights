...
const out=path.join(root,'output/demo-film-v2'),assets=path.join(here,'public/final');
fs.mkdirSync(assets,{recursive:true});
const input=JSON.parse(fs.readFileSync(path.join(root,'output/demo-film-v2/edit-decision.json'),'utf8'));
